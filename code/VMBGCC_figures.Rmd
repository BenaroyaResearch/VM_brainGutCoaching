---
title: "VMBGCC Brain-Gut Coaching Class: Manuscript Figures & Tables"
output:
  html_document:
    toc: true
    toc_float: true
...
# Figure 1: Study Flow Diagram (text-based)
...
# Figure 2: Pre/Post Clinical Scores
...
# Figure 3: IBS-SSS Severity Band Alluvial Diagram
...
# Figure 4: Thematic Coding Summary

```{r figure4, fig.width=9, fig.height=6}
...
# Figure 5: Diagnosis Landscape (UpSet)
...
# Figure 6: Subgroup Forest Plot — IBS-SSS Effect Sizes

```{r figure6, fig.width=9, fig.height=7}
...
# Supplementary: IBS-SSS Waterfall Plot

```{r suppWaterfall, fig.width=8, fig.height=5}
ibsPaired <- ibsPaired %>%
  arrange(deltaIBSSSS) %>%
...
# Supplementary: Healthcare Utilization

```{r suppUtilization, fig.width=10, fig.height=4}
...
# Supplementary: Power Analysis Table
