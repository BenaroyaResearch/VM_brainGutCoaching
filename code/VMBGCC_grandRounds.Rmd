---
title: "VMBGCC Grand Rounds Figures"
subtitle: "10-minute slide deck — descriptive + qualitative-led"
date: "`r Sys.Date()`"
output:
  html_document:
    toc: true
...
# Slide 1 — Who Came (Cohort Snapshot)

```{r slide1-cohort, fig.width=13, fig.height=7.3}
N <- nrow(bgcc.df)
...
# Slide 2 — Class Anatomy / Data Flow

```{r slide2-flow, fig.width=13, fig.height=7.3}
...
# Slide 3 — Theme Prevalence (Headline Qualitative)

```{r slide3-theme-prevalence, fig.width=13, fig.height=7.5}
...
# Slide 4 — Voices (Representative Quotes)

```{r slide4-voices, fig.width=13, fig.height=7.3}
...
# Slide 5 — Micro-Goals: What Patients Chose To Do

```{r slide5-microgoals, fig.width=13, fig.height=7.3}
...
# Slide 6 — Clinical Outcomes (Descriptive)
...
```{r slide6-outcomes-composite, fig.width=15, fig.height=7.3}
...
## Solo IBS-SSS (swap option)

```{r slide6b-outcomes-ibs-solo, fig.width=13, fig.height=7.3}
...
# Slide 7 (Backup) — Theme × Outcome Heatmap

```{r slide7-heatmap, fig.width=13, fig.height=7.8}
...
# Slide 7b (Backup) — Unpacking the Heatmap: Baseline vs Change by Theme

```{r slide7b-heatmap-unpack, fig.width=14, fig.height=7.8}
...
# Slide 7c (Backup) — Severity-Status Change Groups

```{r slide7c-status-change, fig.width=13, fig.height=7.3}
...
# Slide 7d (Backup) — Themes by Status-Change Group

```{r slide7d-status-by-theme, fig.width=14, fig.height=7.5}
...
# Slide 8 (Backup) — IBS-SSS Severity Transitions

```{r slide8-alluvial, fig.width=13, fig.height=7.3}
ibsPaired <- bgcc.df %>%
  filter(!is.na(preIBSSSS) & !is.na(postIBSSSS)) %>%
