---
title: "VMBGCC Brain-Gut Coaching Class: Thematic Analysis"
output:
  html_document:
    toc: true
    toc_float: true
...
# 1. Theme prevalence (Consensus Review)

```{r themePrevalence, fig.width=8, fig.height=6}
...
```{r themeBarplot, fig.width=9, fig.height=6}
...
# 2. Theme co-occurrence

```{r themeCooccurrence, fig.width=8, fig.height=7}
...
```{r cooccurrenceHeatmap, fig.width=9, fig.height=8}
...
# 3. Themes × quantitative outcomes (exploratory)
...
# 5. AI Review comparison (exploratory)
...
# 6. Thematic summary for manuscript
