# Run VMBGCC_descriptives.Rmd
# Usage: Rscript code/run_descriptives.R
...
knitr::purl("code/VMBGCC_descriptives.Rmd", output = "code/VMBGCC_descriptives.R", quiet = TRUE)
source("code/VMBGCC_descriptives.R")
