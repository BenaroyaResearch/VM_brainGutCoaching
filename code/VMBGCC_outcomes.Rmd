---
title: "VMBGCC Brain-Gut Coaching Class: Quantitative Outcome Analysis"
output:
  html_document:
    toc: true
    toc_float: true
...
# 1. Primary pre/post clinical score changes

## 1a. IBS Symptom Severity Score (IBS-SSS)
...
## 1d. Multiple testing correction (FDR)
...
## 2a. IBS-SSS severity band transitions

```{r ibsSSS_clinicalChange}
...
## 2b. PHQ-2 screening transitions
...
## 2c. GAD-7 severity band transitions
...
# 3. IBS-SSS deep dive — class effect interrogation

## 3a. Overall IBS-SSS characterization

```{r ibsWaterfall, fig.width=8, fig.height=5}
...
## 3b. Mixed-effects model with class date random intercept
...
## 3c. Predictors of IBS-SSS response
...
## 3d. Subgroup: IBS-SSS by baseline severity

```{r ibsSubgroupBySeverity}
...
# 4. Healthcare utilization changes
